...
{
    public static class DetalhesViewModelFaker
    {
        public static Faker<DetalhesViewModel> GerarDetalhesEstatico { get; } =
           new Faker<DetalhesViewModel>()
        ...
        public static Faker<DetalhesViewModel> GerarDetalhesComPdfEstatico { get; } =
           new Faker<DetalhesViewModel>()
               ...
               .RuleFor(p => p.Avaliacao, f => 4)
               .RuleFor(p => p.Capitulos, CapituloViewModelFaker.GerarPdfs())
